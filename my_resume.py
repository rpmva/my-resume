...
@app.route('/courses-directory')
def show_all_courses():
    courses = Course.query.all()
    return render_template('course-all.html', courses=courses)


@app.route('/courses-directory/edit/<int:id>', methods=['GET', 'POST'])
def edit_course(id):
...
@app.route('/courses-directory/add', methods=['GET', 'POST'])
def add_courses():
    if request.method == 'GET':
...
@app.route('/courses-directory/delete/<int:id>', methods=['GET', 'POST'])
